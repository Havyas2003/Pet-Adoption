...
<section id="book-a-table" class="book-a-table">
    ...
    <div class="section-title">
      <h2>Adoption</h2>
      <p>Create Animal Profile</p>
    </div>

    <div>

        <form action="../functions.php" method="post" enctype="multipart/form-data" data-aos="fade-up" data-aos-delay="100">
          ...
          <br>
          <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
            <select class="form-select" name="animalType">
              <option selected>Age(Years)</option>
              <option value="Dog">0-1</option>
              <option value="Cat">1-2</option>
              <option value="Other">2 and above</option>
            </select>
          </div>
          <br>
          <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
          ...
          <br>
          <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
            <input type="text" name="colour" class="form-control" placeholder="Animal Colour">
          </div>
          <br>
          <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
          ...
          <br>
          <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
            <select class="form-select" name="dewormed">
              <option selected>Dewormed Status</option>
              <option value="Yes">Yes</option>
              <option value="No">No</option>
            </select>
          </div>
          ...
          <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
            <select class="form-select" name="neutered">
              <option selected>Neutered Status</option>
              <option value="Yes">Yes</option>
              <option value="No">No</option>
            </select>
          </div>
          <br>
          <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
            <input type="text" name="animalCondition" class="form-control" placeholder="Condition">
          </div>
          <br>
          <button type="submit" name="submitAnimalProfile">Submit</button>
        </form>
