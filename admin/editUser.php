  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-phone d-flex align-items-center"><span>+1910 9876543210</span></i>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <?php 
            ...
            while($row = $result->fetch_assoc()) {
              echo "
                <form action'editUser.php' method='post' data-aos='fade-up' data-aos-delay='100'>
                ...
                <input type='text' name='newUsername' class='form-control' value='" . $row["username"] . "'>
                </div>
                <br>
                <div class='form-group'>
                <p>Email : " . $row["email"] . "</p>
                <input type='email' name='newEmail' class='form-control' value='" . $row["email"] . "'>
                </div>
                <br>
                <button class='loginbtn'  type='submit' name='editUser'>Edit User</button>
                </form>
                <br>
                ";
                }
