...
<section id="menu" class="menu section-bg">
  <div class="container" data-aos="fade-up">
    ...
    <div class="col-lg-6 menu-item">
        <img src="../assets/img/default.jpg" class="menu-img" alt="default image">
        <div class="menu-content">
          <a href="createAnimalProfile.php">Create New Animal Profile</a>
        </div>
        <div class="menu-ingredients">
          Click on "Create New Animal Profile" to create a new animal profile
        </div>
      </div>
...
<div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <?php
          ...
          $sql = "SELECT animalName, age, gender, colour, imgType, animalType, id FROM animal";
