...
<head>
  ...
  <title>Home Pets - Register</title>
...
<section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <div class="loginbox">
        <p><img src="assets/img/register.gif" class="center" style="height: 130px;margin-top: -41px"></p>

        <form action="register.php" method="post" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-4 col-md-6 form-group" style="margin-left: 70px; width: 65%">
            <input type="text" name="username" class="form-control" placeholder="Username" value="<?php echo $username; ?>">
            </div>
            <br>
          <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0" style="margin-left: 70px; width: 65%">
          ...
          <br>
          <div><button class="loginbtn" type="submit" name="register_btn">Register</button></div>
          <br><br>
          <p>
