...
<main id="main">
    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <div class="loginbox">
        <p style="font-size: 25px; text-align:center;">LOGIN &nbsp;<img src="assets/img/login.gif" class="center" style="height: 130px;text-align: center;"></p>
        <form action="login.php" method="post" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-4 col-md-6 form-group" style="margin-left: 55px; width: 65%">
              <input type="text" name="username" class="form-control" placeholder="Username">
          </div>
          <br>
          <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0" style="margin-left: 55px; width: 65%">
              <input type="password" name="password" class="form-control" placeholder="Password">
          </div>
          <br>
          <div><button class="loginbtn" type="submit" name="login_btn">Log In</button>
          <br><br>
             <span><a href="register.php"><p style="font-size:17px; margin-left: 55px">Don't have an account?</a></p></span>
          </div>
        </form>
        </div>
